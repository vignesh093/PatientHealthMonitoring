...
public class DbUtils {
   ...
   private static DataSource createMysqldatasource() throws Exception
   {
       String dbName = "iot";
       ...
       String MYSQL_DATA_SOURCE = "com.mysql.cj.jdbc.MysqlDataSource";
   
       Class<?> nsDataSource = null;
       try {
           nsDataSource = Class.forName(MYSQL_DATA_SOURCE);
       }
